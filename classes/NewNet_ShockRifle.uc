...
DefaultProperties
{
    FireModeClass(0)=class'UTCompv18bKAlpha.NewNet_ShockBeamFire'
    FireModeClass(1)=class'UTCompv18bKAlpha.NewNet_ShockProjFire'
    PickupClass=Class'UTCompv18bKAlpha.NewNet_ShockRiflePickup'
}
