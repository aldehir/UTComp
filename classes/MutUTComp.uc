...
#exec OBJ LOAD FILE=Textures/minimegatex.utx PACKAGE=UTCompv18bKAlpha
...
function SetupColoredDeathMessages()
{
    if(Level.Game.DeathMessageClass==class'xGame.xDeathMessage')
        Level.Game.DeathMessageClass=class'UTCompv18bKAlpha.UTComp_xDeathMessage';
    else if(Level.Game.DeathMessageClass==Class'SkaarjPack.InvasionDeathMessage')
        Level.Game.DeathMessageClass=class'UTCompv18bKAlpha.UTComp_InvasionDeathMessage';
}
...
function SetupStats()
{
    ...
    class'xWeapons.AssaultRifle'.default.FireModeClass[0] = Class'UTCompv18bKAlpha.UTComp_AssaultFire';
    class'xWeapons.AssaultRifle'.default.FireModeClass[1] = Class'UTCompv18bKAlpha.UTComp_AssaultGrenade';

    class'xWeapons.BioRifle'.default.FireModeClass[0] = Class'UTCompv18bKAlpha.UTComp_BioFire';
    class'xWeapons.BioRifle'.default.FireModeClass[1] = Class'UTCompv18bKAlpha.UTComp_BioChargedFire';

    class'xWeapons.ShockRifle'.default.FireModeClass[0] = Class'UTCompv18bKAlpha.UTComp_ShockBeamFire';
    class'xWeapons.ShockRifle'.default.FireModeClass[1] = Class'UTCompv18bKAlpha.UTComp_ShockProjFire';

    class'xWeapons.LinkGun'.default.FireModeClass[0] = Class'UTCompv18bKAlpha.UTComp_LinkAltFire';
    class'xWeapons.LinkGun'.default.FireModeClass[1] = Class'UTCompv18bKAlpha.UTComp_LinkFire';

    class'xWeapons.MiniGun'.default.FireModeClass[0] = Class'UTCompv18bKAlpha.UTComp_MinigunFire';
    class'xWeapons.MiniGun'.default.FireModeClass[1] = Class'UTCompv18bKAlpha.UTComp_MinigunAltFire';

    class'xWeapons.FlakCannon'.default.FireModeClass[0] = Class'UTCompv18bKAlpha.UTComp_FlakFire';
    class'xWeapons.FlakCannon'.default.FireModeClass[1] = Class'UTCompv18bKAlpha.UTComp_FlakAltFire';

    class'xWeapons.RocketLauncher'.default.FireModeClass[0] = Class'UTCompv18bKAlpha.UTComp_RocketFire';
    class'xWeapons.RocketLauncher'.default.FireModeClass[1] = Class'UTCompv18bKAlpha.UTComp_RocketMultiFire';

    class'xWeapons.SniperRifle'.default.FireModeClass[0]= Class'UTCompv18bKAlpha.UTComp_SniperFire';
    class'UTClassic.ClassicSniperRifle'.default.FireModeClass[0]= Class'UTCompv18bKAlpha.UTComp_ClassicSniperFire';

    class'Onslaught.ONSMineLayer'.default.FireModeClass[0] = Class'UTCompv18bKAlpha.UTComp_ONSMineThrowFire';

    class'Onslaught.ONSGrenadeLauncher'.default.FireModeClass[0] =Class'UTCompv18bKAlpha.UTComp_ONSGrenadeFire';

    class'OnsLaught.ONSAvril'.default.FireModeClass[0] =Class'UTCompv18bKAlpha.UTComp_ONSAvrilFire';

    class'xWeapons.SuperShockRifle'.default.FireModeClass[0]=class'UTCompv18bKAlpha.UTComp_SuperShockBeamFire';
    class'xWeapons.SuperShockRifle'.default.FireModeClass[1]=class'UTCompv18bKAlpha.UTComp_SuperShockBeamFire';
...
simulated function Tick(float DeltaTime)
{
    ...
    if(PC!=None)
    {
        PC.Player.InteractionMaster.AddInteraction("UTCompv18bKAlpha.UTComp_Overlay", PC.Player);
...
function ReplacePawnAndPC()
{
    if(Level.Game.DefaultPlayerClassName~="xGame.xPawn")
        Level.Game.DefaultPlayerClassName="UTCompv18bKAlpha.UTComp_xPawn";
    if(class'xPawn'.default.ControllerClass==class'XGame.XBot') //bots don't skin otherwise
        class'xPawn'.default.ControllerClass=class'UTCompv18bKAlpha.UTComp_xBot';

    Level.Game.PlayerControllerClassName="UTCompv18bKAlpha.BS_xPlayer";
}
...
function PostBeginPlay()
{
    ...
    SetupWarmup();
    if(bForward)
        Level.Game.AddMutator("UTCompv18bKAlpha.Forward_Mutator", true);
...
function ModifyLogin(out string Portal, out string Options)
{
	...
	if (bSeeAll && bSpectator) {
		...
		Level.Game.PlayerControllerClassName = "UTCompv18bKAlpha.UTV_BS_xPlayer";
    ...
    if(Level.Game.ScoreBoardType~="xInterface.ScoreBoardDeathMatch")
    {
        if(bEnableScoreBoard)
            Level.Game.ScoreBoardType="UTCompv18bKAlpha.UTComp_ScoreBoard";
        else
            Level.Game.ScoreBoardType="UTCompv18bKAlpha.UTComp_ScoreBoardDM";
    }
    else if(Level.Game.ScoreBoardType~="xInterface.ScoreBoardTeamDeathMatch")
    {
        if(bEnableScoreBoard)
            ...
            Level.Game.ScoreBoardType="UTCompv18bKAlpha.UTComp_ScoreBoardTDM";
    }
    else if(Level.Game.ScoreBoardType~="UT2k4Assault.ScoreBoard_Assault")
    {
        Level.Game.ScoreBoardType="UTCompv18bKAlpha.UTComp_ScoreBoard_AS";
    }
    else if(Level.game.scoreboardtype~="BonusPack.MutantScoreboard")
    {
        Level.Game.ScoreBoardType="UTCompv18bKAlpha.UTComp_ScoreBoard_Mutant";
    }

    Super.ModifyLogin(Portal, Options);

    if(level.game.hudtype~="xInterface.HudCTeamDeathmatch")
        Level.Game.HudType="UTCompv18bKAlpha.UTComp_HudCTeamDeathmatch";
    else if(level.game.hudtype~="xInterface.HudCDeathmatch")
        Level.Game.HudType="UTCompv18bKAlpha.UTComp_HudCDeathmatch";
    else if(level.game.hudtype~="xInterface.HudCBombingRun")
        Level.Game.HudType="UTCompv18bKAlpha.UTComp_HudCBombingRun";
    else if(level.game.hudtype~="xInterface.HudCCaptureTheFlag")
        Level.Game.HudType="UTCompv18bKAlpha.UTComp_HudCCaptureTheFlag";
    else if(level.game.hudtype~="xInterface.HudCDoubleDomination")
        Level.Game.HudType="UTCompv18bKAlpha.UTComp_HudCDoubleDomination";
    else if(level.game.hudtype~="Onslaught.ONSHUDOnslaught")
        Level.Game.HudType="UTCompv18bKAlpha.UTComp_ONSHUDOnslaught";
    else if(level.game.hudtype~="SkaarjPack.HudInvasion")
        Level.Game.HudType="UTCompv18bKAlpha.UTComp_HudInvasion";
    else if(level.game.hudtype~="BonusPack.HudLMS")
        Level.Game.HudType="UTCompv18bKAlpha.UTComp_HudLMS";
    else if(level.game.hudtype~="BonusPack.HudMutant")
        Level.Game.HudType="UTCompv18bKAlpha.UTComp_HudMutant";
    else if(level.game.hudtype~="ut2k4assault.Hud_Assault")
        Level.Game.HudType="UTCompv18bKAlpha.UTComp_Hud_Assault";
}
...
{
    if(class'UTCompv18bKAlpha.MutUTComp'.default.bEnableAutoDemorec)
    {
...
{
    local string S;
    S=class'UTCompv18bKAlpha.MutUTComp'.default.AutoDemoRecMask;
...
defaultproperties
{
     ...
     ServerMaxPlayers=12
     AlwaysUseThisMutator(0)="UTCompv18bKAlpha.MutUTComp"
     ...
     VotingGametype(5)=(GametypeOptions="?game=UTCompv18bKAlpha.UTComp_ClanArena?goalscore=7?TimeLimit=2?FriendlyFireScale=0?GrenadesOnSpawn=4?TimedOverTimeLength=0",GametypeName="Clan Arena")
     ...
     FriendlyName="UTComp Version 1.8b-KAlpha"
     FriendlyVersionPrefix="UTComp Version"
     FriendlyVersionNumber="1.8b-KAlpha"
     ...
     WeaponClasses(0)=Class'UTCompv18bKAlpha.NewNet_ShockRifle'
     WeaponClasses(1)=Class'UTCompv18bKAlpha.NewNet_LinkGun'
     WeaponClasses(2)=Class'UTCompv18bKAlpha.NewNet_MiniGun'
     WeaponClasses(3)=Class'UTCompv18bKAlpha.NewNet_FlakCannon'
     WeaponClasses(4)=Class'UTCompv18bKAlpha.NewNet_RocketLauncher'
     WeaponClasses(5)=Class'UTCompv18bKAlpha.NewNet_SniperRifle'
     WeaponClasses(6)=Class'UTCompv18bKAlpha.NewNet_BioRifle'
     WeaponClasses(7)=Class'UTCompv18bKAlpha.NewNet_AssaultRifle'
     WeaponClasses(8)=Class'UTCompv18bKAlpha.NewNet_ClassicSniperRifle'
     WeaponClasses(9)=Class'UTCompv18bKAlpha.NewNet_ONSAVRiL'
     WeaponClasses(10)=Class'UTCompv18bKAlpha.NewNet_ONSMineLayer'
     WeaponClasses(11)=Class'UTCompv18bKAlpha.NewNet_ONSGrenadeLauncher'
     WeaponClasses(12)=Class'UTCompv18bKAlpha.NewNet_SuperShockRifle'
     ...
     WeaponPickupClasses(0)=Class'UTCompv18bKAlpha.NewNet_ShockRiflePickup'
     WeaponPickupClasses(1)=Class'UTCompv18bKAlpha.NewNet_LinkGunPickup'
     WeaponPickupClasses(2)=Class'UTCompv18bKAlpha.NewNet_MiniGunPickup'
     WeaponPickupClasses(3)=Class'UTCompv18bKAlpha.NewNet_FlakCannonPickup'
     WeaponPickupClasses(4)=Class'UTCompv18bKAlpha.NewNet_RocketLauncherPickup'
     WeaponPickupClasses(5)=Class'UTCompv18bKAlpha.NewNet_SniperRiflePickup'
     WeaponPickupClasses(6)=Class'UTCompv18bKAlpha.NewNet_BioRiflePickup'
     WeaponPickupClasses(7)=Class'UTCompv18bKAlpha.NewNet_AssaultRiflePickup'
     WeaponPickupClasses(8)=Class'UTCompv18bKAlpha.NewNet_ClassicSniperRiflePickup'
     WeaponPickupClasses(9)=Class'UTCompv18bKAlpha.NewNet_ONSAVRiLPickup'
     WeaponPickupClasses(10)=Class'UTCompv18bKAlpha.NewNet_ONSMineLayerPickup'
     WeaponPickupClasses(11)=Class'UTCompv18bKAlpha.NewNet_ONSGrenadePickup'
     WeaponPickupClassNames(0)="UTCompv18bKAlpha.NewNet_ShockRiflePickup"
     WeaponPickupClassNames(1)="UTCompv18bKAlpha.NewNet_LinkGunPickup"
     WeaponPickupClassNames(2)="UTCompv18bKAlpha.NewNet_MiniGunPickup"
     WeaponPickupClassNames(3)="UTCompv18bKAlpha.NewNet_FlakCannonPickup"
     WeaponPickupClassNames(4)="UTCompv18bKAlpha.NewNet_RocketLauncherPickup"
     WeaponPickupClassNames(5)="UTCompv18bKAlpha.NewNet_SniperRiflePickup"
     WeaponPickupClassNames(6)="UTCompv18bKAlpha.NewNet_BioRiflePickup"
     WeaponPickupClassNames(7)="UTCompv18bKAlpha.NewNet_AssaultRiflePickup"
     WeaponPickupClassNames(8)="UTCompv18bKAlpha.NewNet_ClassicSniperRiflePickup"
     WeaponPickupClassNames(9)="UTCompv18bKAlpha.NewNet_ONSAVRiLPickup"
     WeaponPickupClassNames(10)="UTCompv18bKAlpha.NewNet_ONSMineLayerPickup"
     WeaponPickupClassNames(11)="UTCompv18bKAlpha.NewNet_ONSGrenadePickup"
