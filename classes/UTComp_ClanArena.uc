...
function AddGameSpecificInventory(Pawn p)
{
    ...
    {
        p.CreateInventory("UTCompv18bKAlpha.UTComp_ShieldGun");
        p.CreateInventory("UTCompv18bKAlpha.UTComp_AssaultRifle");
        p.CreateInventory("UTCompv18bKAlpha.UTComp_BioRifle");
        p.CreateInventory("UTCompv18bKAlpha.UTComp_MiniGun");
        p.CreateInventory("UTCompv18bKAlpha.UTComp_ShockRifle");
        p.CreateInventory("UTCompv18bKAlpha.UTComp_LinkGun");
        p.CreateInventory("UTCompv18bKAlpha.UTComp_FlakCannon");
        p.CreateInventory("UTCompv18bKAlpha.UTComp_RocketLauncher");
        p.CreateInventory("UTCompv18bKAlpha.UTComp_SniperRifle");
   }
   else
   {
        p.CreateInventory("UTCompv18bKAlpha.UTComp_ShieldGun");
        p.CreateInventory("UTCompv18bKAlpha.NewNet_AssaultRifle");
        p.CreateInventory("UTCompv18bKAlpha.NewNet_BioRifle");
        p.CreateInventory("UTCompv18bKAlpha.NewNet_MiniGun");
        p.CreateInventory("UTCompv18bKAlpha.NewNet_ShockRifle");
        p.CreateInventory("UTCompv18bKAlpha.NewNet_LinkGun");
        p.CreateInventory("UTCompv18bKAlpha.NewNet_FlakCannon");
        p.CreateInventory("UTCompv18bKAlpha.NewNet_RocketLauncher");
        p.CreateInventory("UTCompv18bKAlpha.NewNet_SniperRifle");
   }
...
DefaultProperties
{
     ...
     TimeLimit = 2
     GoalScore=8
     GameName="UTComp Clan Arena 1.8b-KAlpha"
     bAllowWeaponThrowing=false
     SecondaryMutatorClass="UTCompv18bKAlpha.MutUTComp"
     Round_Health = 150
     Round_Armor = 100
