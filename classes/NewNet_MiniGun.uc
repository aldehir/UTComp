...
DefaultProperties
{
    FireModeClass(0)=class'UTCompv18bKAlpha.NewNet_MiniGunFire'
    FireModeClass(1)=class'UTCompv18bKAlpha.NewNet_MiniGunAltFire'
    PickupClass=Class'UTCompv18bKAlpha.NewNet_MiniGunPickup'
}
