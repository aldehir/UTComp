...
function PostBeginPlay()
{
    ...
    Level.Game.DefaultPlayerClassName="UTCompv18bKAlpha.Forward_Pawn";
    Level.Game.PlayerControllerClassName="UTCompv18bKAlpha.Forward_xPlayer";
}
  ...
  /* if(bEnhancedNetCodeEnabledAtStartOfMap)
   {
    ...
    {
        ReplaceWith(Other,"UTCompv18bKAlpha.Forward_MiniHealthPack");
        return false;
    }
    else if(Other.IsA('HealthPack') && Other.Class == class'HealthPack')
    {
        ReplaceWith(Other,"UTCompv18bKAlpha.Forward_HealthPack");
        return false;
    }
    else if(Other.IsA('SuperHealthPack') && Other.Class == class'SuperHealthPack')
    {
        ReplaceWith(Other,"UTCompv18bKAlpha.Forward_SuperHealthPack");
        return false;
    }
    else if(Other.IsA('ShieldPack') && Other.Class == class'ShieldPack')
    {
        ReplaceWith(Other,"UTCompv18bKAlpha.Forward_ShieldPack");
        return false;
    }
    else if(Other.IsA('SuperShieldPack') && Other.Class == class'SuperShieldPack')
    {
        ReplaceWith(Other,"UTCompv18bKAlpha.Forward_SuperShieldPack");
        return false;
    }
...
DefaultProperties
{
     ...
     WeaponClassNames(0)="UTCompv18bKAlpha.Forward_NewNet_ShockRifle"
     WeaponClassNames(1)="UTCompv18bKAlpha.Forward_NewNet_LinkGun"
     WeaponClassNames(2)="UTCompv18bKAlpha.Forward_NewNet_MiniGun"
     WeaponClassNames(3)="UTCompv18bKAlpha.Forward_NewNet_FlakCannon"
     WeaponClassNames(4)="UTCompv18bKAlpha.Forward_NewNet_RocketLauncher"
     WeaponClassNames(5)="UTCompv18bKAlpha.Forward_NewNet_SniperRifle"
     WeaponClassNames(6)="UTCompv18bKAlpha.Forward_NewNet_BioRifle"
     WeaponClassNames(7)="UTCompv18bKAlpha.Forward_NewNet_AssaultRifle"
     WeaponClassNames(8)="UTCompv18bKAlpha.Forward_NewNet_SniperRifle"
     WeaponClassNames(9)="UTCompv18bKAlpha.NewNet_ONSAVRiL"
     WeaponClassNames(10)="UTCompv18bKAlpha.NewNet_ONSMineLayer"
     WeaponClassNames(11)="UTCompv18bKAlpha.NewNet_ONSGrenadeLauncher"

     AltWeaponClassNames(0)="UTCompv18bKAlpha.Forward_UTComp_ShockRifle"
     AltWeaponClassNames(1)="UTCompv18bKAlpha.Forward_UTComp_LinkGun"
     AltWeaponClassNames(2)="UTCompv18bKAlpha.Forward_UTComp_MiniGun"
     AltWeaponClassNames(3)="UTCompv18bKAlpha.Forward_UTComp_FlakCannon"
     AltWeaponClassNames(4)="UTCompv18bKAlpha.Forward_UTComp_RocketLauncher"
     AltWeaponClassNames(5)="UTCompv18bKAlpha.Forward_UTComp_SniperRifle"
     AltWeaponClassNames(6)="UTCompv18bKAlpha.Forward_UTComp_BioRifle"
     AltWeaponClassNames(7)="UTCompv18bKAlpha.Forward_UTComp_AssaultRifle"
     AltWeaponClassNames(8)="UTCompv18bKAlpha.Forward_UTComp_SniperRifle"
     ...
     NewNetWeaponClassNames(0)="UTCompv18bKAlpha.NewNet_ShockRifle"
     NewNetWeaponClassNames(1)="UTCompv18bKAlpha.NewNet_LinkGun"
     NewNetWeaponClassNames(2)="UTCompv18bKAlpha.NewNet_MiniGun"
     NewNetWeaponClassNames(3)="UTCompv18bKAlpha.NewNet_FlakCannon"
     NewNetWeaponClassNames(4)="UTCompv18bKAlpha.NewNet_RocketLauncher"
     NewNetWeaponClassNames(5)="UTCompv18bKAlpha.NewNet_SniperRifle"
     NewNetWeaponClassNames(6)="UTCompv18bKAlpha.NewNet_BioRifle"
     NewNetWeaponClassNames(7)="UTCompv18bKAlpha.NewNet_AssaultRifle"
     NewNetWeaponClassNames(8)="UTCompv18bKAlpha.NewNet_ClassicSniperRifle"
     NewNetWeaponClassNames(9)="UTCompv18bKAlpha.NewNet_ONSAVRiL"
     NewNetWeaponClassNames(10)="UTCompv18bKAlpha.NewNet_ONSMineLayer"
     NewNetWeaponClassNames(11)="UTCompv18bKAlpha.NewNet_ONSGrenadeLauncher"

     UTCompWeaponClassNames(0)="UTCompv18bKAlpha.UTComp_ShockRifle"
     UTCompWeaponClassNames(1)="UTCompv18bKAlpha.UTComp_LinkGun"
     UTCompWeaponClassNames(2)="UTCompv18bKAlpha.UTComp_MiniGun"
     UTCompWeaponClassNames(3)="UTCompv18bKAlpha.UTComp_FlakCannon"
     UTCompWeaponClassNames(4)="UTCompv18bKAlpha.UTComp_RocketLauncher"
     UTCompWeaponClassNames(5)="UTCompv18bKAlpha.UTComp_SniperRifle"
     UTCompWeaponClassNames(6)="UTCompv18bKAlpha.UTComp_BioRifle"
     UTCompWeaponClassNames(7)="UTCompv18bKAlpha.UTComp_AssaultRifle"
     UTCompWeaponClassNames(8)="UTCompv18bKAlpha.UTComp_ClassicSniperRifle"
     UTCompWeaponClassNames(9)="UTCompv18bKAlpha.UTComp_ONSAVRiL"
     UTCompWeaponClassNames(10)="UTCompv18bKAlpha.UTComp_ONSMineLayer"
     UTCompWeaponClassNames(11)="UTCompv18bKAlpha.UTComp_ONSGrenadeLauncher"
