class NewNet_BlueSuperShockBeam extends BlueSuperShockBeam;
...
simulated function SpawnEffects()
{
    ...
    E = Spawn(class'NewNet_ExtraBlueBeam', Owner);
    if ( E != None )
...
defaultproperties
{
     CoilClass=Class'UTCompv18b_k1_alpha.NewNet_ShockBeamCoilBlue'
}
