    ...
    if(myHud!=None && myHUD.ScoreBoard.IsA('UTComp_ScoreBoard') && gamereplicationinfo!=None)
    {
        if(class'UTComp_Settings'.default.bUseDefaultScoreboard)
        {
            if(gamereplicationinfo.bTeamGame)
                NewScoreboardClass=class'UTCompv18b_k1_alpha.UTComp_ScoreBoardTDM';
            else
                NewScoreboardClass=class'UTCompv18b_k1_alpha.UTComp_ScoreBoardDM';
            clientChangedScoreboard=True;
        }
    }
    else if(ClientChangedScoreBoard && !class'UTComp_Settings'.default.bUseDefaultScoreboard)
        NewScoreboardClass=class'UTCompv18b_k1_alpha.UTComp_ScoreBoard';
...
defaultproperties
{
     ...
     UTCompMenuClass="UTCompv18b_k1_alpha.UTComp_Menu_OpenedMenu"
     UTCompVotingMenuClass="UTCompv18b_k1_alpha.UTComp_Menu_VoteInProgress"
