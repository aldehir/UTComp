...
DefaultProperties
{
    FireModeClass(0)=class'UTCompv18bKAlpha.NewNet_AssaultFire'
    FireModeClass(1)=class'UTCompv18bKAlpha.NewNet_AssaultGrenade'
    PickupClass=Class'UTCompv18bKAlpha.NewNet_AssaultRiflePickup'
}
